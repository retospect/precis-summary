...
STOPWORDS: frozenset[str] = frozenset({
    ...
    "abstract", "according", "achieved", "additionally", "aim", "aimed",
    "approach", "article", "author", "authors",
    "case", "compared", "conclusion", "conclusions", "conducted",
    "considered", "corresponding", "data", "demonstrate", "demonstrated",
    "demonstrates", "described", "discussion", "effect", "effects",
    "employed", "et", "al", "evidence", "examined", "experiment",
    "experimental", "experiments", "fig", "figure", "finally",
    "furthermore", "general", "generally", "high", "higher", "important",
    "increase", "increased", "indicate", "indicated", "indicates",
    "investigated", "investigation", "involve", "involved", "involves",
    "large", "low", "lower", "method", "methods",
    "moreover", "notably", "note", "observed", "obtained",
    "order", "overall", "paper", "particular", "particularly",
    "performed", "present", "presented", "previous", "previously",
    "process", "proposed", "provide", "provided", "provides",
    "range", "recent", "recently", "report", "reported", "reports",
    "respectively", "result", "resulting", "results", "revealed",
    "review", "role", "sample", "samples", "significant",
    "significantly", "similar", "similarly", "specific", "specifically",
    "structure", "structures", "studied", "studies", "study",
    "suggest", "suggested", "suggests", "summary", "support",
    "table", "technique", "techniques", "test", "tested",
    "total", "type", "types", "typical", "typically",
    "value", "values", "whereas", "widely",
    # Also common generic
    "also", "already", "although", "always", "among",
